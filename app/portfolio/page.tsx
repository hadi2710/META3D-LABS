  ...
  const projects = [
    {
      ...
      image: "/images/modern-smart-home-dashboard-interface.jpg",
    ...
    },
    {
      ...
      image: "/images/medical-device-prototype-3d-printed.jpg",
    ...
    },
    {
      ...
      image: "/images/modern-ecommerce-platform.png",
    ...
    },
    {
      ...
      image: "/images/custom-drone-with-control-interface.jpg",
    ...
    },
    {
      ...
      image: "/images/industrial-3d-printed-mechanical-parts.jpg",
    ...
    },
    {
      ...
      image: "/images/fintech-startup-app-interface.jpg",
  ...
  return (
    <>
      <main className="min-h-[100dvh] text-white bg-gray-900">
        ...
        {/* Hero */}
        <section className="relative py-24 px-4 bg-gradient-to-b from-gray-900/80 to-gray-900">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Explore featured projects showcasing the power of integrated technology solutions. From concept to completion.
            </p>
          </div>
        </section>
  ...
  <div className="container mx-auto max-w-6xl">
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {projects.map((project) => (
        <Card
          key={project.id}
          className="liquid-glass border-gray-800 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 group"
        >
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <div className="liquid-glass rounded-2xl p-12 bg-gray-800/80">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  asChild
                  className="bg-cyan-400 text-black font-medium rounded-lg px-8 py-3 text-lg hover:bg-cyan-300 hover:shadow-md hover:scale-[1.02] transition-all"
                >
                ...
                <Button
                  asChild
                  variant="outline"
                  className="border-gray-600 text-gray-300 rounded-lg px-8 py-3 text-lg hover:bg-gray-800 hover:border-gray-500 transition-all bg-transparent"
                >
